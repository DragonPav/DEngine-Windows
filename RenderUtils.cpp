...
void RenderUtils::bind(GLfloat* vertices, GLuint* indices, GLfloat* tex, GLuint vertexBufSize, GLuint indexBufSize, GLuint texBufSize, GLfloat* normal, GLuint normalBufferSize) {
